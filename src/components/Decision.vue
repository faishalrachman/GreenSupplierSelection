            ...
            <table class="table m-t-30">
              <thead>
                ...
                <tr rowspan="1">
                  ...
                  <th class="text-center" v-for="(data, index) in experts()" v-bind:key="index">Expert {{index+1}}</th>
                </tr>
              </thead>
              <tbody>
                <tr v-for="(data,index_alter) in topic.alternatives" v-bind:key="index_alter">
                  ...
                  >
                    ...
                    <select
                      ...
                      class="form-control"
                      style="width:100px;"
                      model="experts()[index_expert].decision[index_alter]"
...
export default {
  ...
  methods: {
    ...
    pilihExpert(index_alter, index_expert, event) {
      ...
      console.log("Index Expert = "+index_expert)
      console.log("Index Alternative = "+index_alter)
      console.log(experts[index_expert].decision);
    }
  },
  created() {
